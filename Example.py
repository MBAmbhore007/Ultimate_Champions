...
filepath = 'C:/Users/MAYUR/OneDrive/Desktop/Plant-Leaf-Disease-Prediction/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/MAYUR/OneDrive/Desktop/Plant-Leaf-Disease-Prediction/Dataset/testTomato___Bacterial_spot (1).JPG')
test_image = cv2.resize(tomato_plant, (128,128)) # load image 
  
test_image = img_to_array(test_image)/255 # convert image to np array and normalize
test_image = np.expand_dims(test_image, axis = 0) # change dimention 3D to 4D
  
result = model.predict(test_image) # predict diseased  or not
