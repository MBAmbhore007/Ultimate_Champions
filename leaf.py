...
def pred_tomato_dieas(tomato_plant):
  ...
  test_image = np.expand_dims(test_image, axis = 0) # change dimention 2D to 3D
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/MAYUR/OneDrive/Desktop/Plant-Leaf-Disease-Prediction/static/upload', filename)
        file.save(file_path)
